...
export const getDriveDist = (lat1: number, long1: number, lat2: number, long2: number, setDistance: (arg: any) => any) => {
	const link = `https://api.mapbox.com/directions/v5/mapbox/driving/${long1},${lat1};${long2},${lat2}?approaches=unrestricted;curb&access_token=pk.eyJ1IjoiYmFuYW5hYXBwb3JnIiwiYSI6ImNrY3R4eW5tdjFreWwycm0xOXpteWNwa3EifQ.Y5o31sEmabfFzCDHQfqrEg`;
